...
const LANGUAGE_DATA = {
  ...
  he: {
    ...
    levelWords: [
      ...
      // Level 2: 2 letters
      [
        "אב", "אם", "אח", "בן", "בת", "גן", "הר", "ים", "יד", "פה",
        "חם", "קר", "חי", "דב", "רע", "מי", "לי", "לו", "גג", "סל",
        "עץ", "קו", "שי", "טל"
      ],
      // Level 3: 3 letters
      [
        "בית", "ילד", "כלב", "שמש", "פרח", "שיר", "לחם", "אור", "חלב", 
        "ספר", "ענן", "רוח", "זהב", "גזר", "דלת", "מלח", "דבש", "שמן"
      ],
      // Level 4: 4 letters
      [
        "ילדה", "חתול", "בלון", "כדור", "מים", "תפוח", "תפוז", "סירה", 
        "ארנב", "כוכב", "עציץ", "שוקו", "שעון", "חלון", "כיסא", "גינה", 
        "חברה"
      ],
      // Level 5: 5 letters
      [
        "גבינה", "גלידה", "לימון", "רכבת", "שמיים", "ציפור", "שולחן", 
        "תמונה", "צלחת", "בקבוק", "סרגלים", "מכתבים", "עפרון", "פרחים", 
        "בגדים", "תינוק"
      ],
      // Level 6: 6 letters
      [
        "עיפרון", "שוקולד", "מטוסים", "מכונית", "כדורגל", "מחברות", 
        "כוכבים", "חתולים", "ספרייה", "מחשבים", "חלונות", "שבועות"
      ],
      // Level 7: 7 letters
      [
        "אופניים", "מספריים", "סוכריות", "צעצועים", "תינוקות", "מכוניות", 
        "צפרדעים", "שולחנות"
      ]
    ]
  }
